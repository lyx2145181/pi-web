...
async function resetSessionIndexState() {
  const state = globalThis.__piSessionIndexState;
  await state?.backgroundValidation?.catch(() => undefined);
  await state?.coordinator?.waitForPersistence();
