...
Сервер разработки прослушивает порт `30141` на всех сетевых интерфейсах. Локально откройте [http://127.0.0.1:30141](http://127.0.0.1:30141), а с другого устройства используйте LAN-адрес хоста. Чтобы ограничить доступ только loopback-интерфейсом, запустите `npm run dev:local`. Основные проверки запускаются командами:
