...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.quickWorktreeSwitch": "快速切換工作樹",
    "sidebar.showAllWorktrees": "顯示所有工作樹的對話",
    "sidebar.allWorktreesShort": "全",
    "sidebar.main": "主分支",
    ...
    "sidebar.unpinnedSessions": "未置頂工作階段",
    "sidebar.pinned": "已置頂",
    "sidebar.pinSession": "置頂工作階段",
    "sidebar.unpinSession": "取消置頂",
    "sidebar.agentRunning": "Agent 執行中…",
    "sidebar.backgroundSessionRunning": "背景工作階段執行中",
    "sidebar.backgroundSessionComplete": "背景工作階段已完成",
