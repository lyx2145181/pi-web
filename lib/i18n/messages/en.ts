...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.quickWorktreeSwitch": "Quick worktree switcher",
    "sidebar.showAllWorktrees": "Show conversations from all worktrees",
    "sidebar.allWorktreesShort": "All",
    "sidebar.main": "main",
    ...
    "sidebar.unpinnedSessions": "Unpinned sessions",
    "sidebar.pinned": "Pinned",
    "sidebar.pinSession": "Pin session",
    "sidebar.unpinSession": "Unpin session",
    "sidebar.agentRunning": "Agent running…",
    "sidebar.backgroundSessionRunning": "Background session running",
    "sidebar.backgroundSessionComplete": "Background session complete",
